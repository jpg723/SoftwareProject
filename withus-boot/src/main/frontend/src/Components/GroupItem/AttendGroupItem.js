  ...
  return (
    <div>
      ...
      <div className="groupBuy-header">
        ...
        <button className="groupStart_btn"  onClick={openModal1}>공동기부 방만들기</button>
        <Modal open={modalOpen1} close={closeModal1} header="공동기부 시작" class="group_order_modal">
        ...
        <form id="order_form">
            ...
            <div id="order_bottom">
              <button id="order_btn" type="submit" onClick={() => startBtn_click()}>생성</button>
            </div>
          </form>
        </Modal>
      </div>
          ...
          attendgroupList.map(function(a,i){
            return(              
                <div className="groupBox2">
                  ...
                  <div className="groupitem-message">{a.message}</div>                                   
