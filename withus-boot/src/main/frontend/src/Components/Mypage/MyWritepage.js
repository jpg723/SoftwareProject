...
document.location.href = "/mypage-mywrite";
}
            ...
            return(
              <div>           
                      ...
                      openItemModal();}} name="viewimg" id="previewimg" alt="" style={{width:"200px", height:"300px", border:"1px solid"}}/>
                {
                    ...
                    <Modal open={itemOpen} close={closItemModal} header="나눔 종료">
                    <main class="cart_text"></main>나눔을 종료하시겠습니까?   
              <div id="order_bottom">
                <button id="order_btn" type="submit" onClick={finishBtn_click(list[i].item_id)}>나눔 종료</button>
              </div>  
                  </Modal> : null
                ...
                <div className={styles.product_name}>{list[i].item_name}</div>
                  ...
                  <div className={styles.product_price}>{list[i].item_state === 0 ? <div>진행중</div> : <div>나눔 종료</div>}</div>
